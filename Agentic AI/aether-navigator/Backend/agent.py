...
#     "ensure_active_tab",
#     description=(
#         "Ensures the agent is focused on the actual active browser tab. "
#         "Automatically gets the CDP active tab, matches it with agent-browser tabs, "
#         "and switches to the correct tab if needed."
#     ),
# )
